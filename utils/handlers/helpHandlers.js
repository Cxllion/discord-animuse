const { EmbedBuilder, ActionRowBuilder, StringSelectMenuBuilder, ButtonBuilder, ButtonStyle, PermissionFlagsBits, MessageFlags } = require('discord.js');
    ...
    try {
        ...
        if (user.id !== targetUserId) {
            return interaction.reply({ 
                content: '🔒 **Archival Restriction**\n\nYou did not invoke this help session, Reader. Please use `/help` to start your own interactive session with the archives.', 
